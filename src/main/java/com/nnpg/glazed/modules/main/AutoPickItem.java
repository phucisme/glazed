...
import com.nnpg.glazed.utils.baritone.MeteoristBaritoneUtils;

import java.util.ArrayList;
import java.util.List;
import java.util.stream.StreamSupport;

public class AutoPickItem extends Module {
    ...
    public AutoPickItem() {
        super(GlazedAddon.CATEGORY, "auto-pickitem", "Automatically picks up dropped items.");
    }
